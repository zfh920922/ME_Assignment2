 ...
 * </p>
 * <ul>
 *   <li>{@link at.ac.tuwien.big.statesml.impl.DataTypeLibraryImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeLibraryImpl extends NamedElementImpl implements DataTypeLibrary {
	...
	public EList<DataType> getTypes() {
		if (types == null) {
			types = new EObjectContainmentEList<DataType>(DataType.class, this, StatesMLPackage.DATA_TYPE_LIBRARY__TYPES);
		}
		return types;
	}
