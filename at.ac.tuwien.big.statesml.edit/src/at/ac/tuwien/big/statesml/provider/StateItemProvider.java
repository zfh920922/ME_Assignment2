...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.statesml.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends NodeItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesMLPackage.Literals.STATE__INITIAL,
				 true,
				 false,
				 false,
	...
	protected void addTerminalPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_State_terminal_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_State_terminal_feature", "_UI_State_type"),
				 StatesMLPackage.Literals.STATE__TERMINAL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatesMLPackage.Literals.STATE__ACTION_SEQUENCE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.STATE__ACTION_SEQUENCE,
