...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.statesml.Node} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesMLPackage.Literals.NODE__OUTGOING_EDGES,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesMLPackage.Literals.NODE__INCOMING_EDGES,
				 true,
				 false,
				 true,
				 null,
