...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.statesml.ParameterValue} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ParameterValueItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesMLPackage.Literals.PARAMETER_VALUE__PARAMETER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatesMLPackage.Literals.PARAMETER_VALUE__VALUE_SPECIFICATION);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.PARAMETER_VALUE__VALUE_SPECIFICATION,
				 StatesMLFactory.eINSTANCE.createIntegerValueSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.PARAMETER_VALUE__VALUE_SPECIFICATION,
				 StatesMLFactory.eINSTANCE.createBooleanValueSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.PARAMETER_VALUE__VALUE_SPECIFICATION,
				 StatesMLFactory.eINSTANCE.createAttributeValueSpecification()));

		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.PARAMETER_VALUE__VALUE_SPECIFICATION,
				 StatesMLFactory.eINSTANCE.createStringValueSpecification()));
	}
