...
/**
 * This is the item provider adapter for a {@link at.ac.tuwien.big.statesml.FunctionCall} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FunctionCallItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 StatesMLPackage.Literals.FUNCTION_CALL__FUNCTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(StatesMLPackage.Literals.FUNCTION_CALL__PARAMETERS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(FunctionCall.class)) {
			case StatesMLPackage.FUNCTION_CALL__PARAMETERS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(StatesMLPackage.Literals.FUNCTION_CALL__PARAMETERS,
				 StatesMLFactory.eINSTANCE.createParameterValue()));
	}
